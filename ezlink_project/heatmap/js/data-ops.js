...
var selectedPassengerType = "Tourist";
...
function streamTapOutData()
{
	...
	return dataAPI.getResJsonStream(datasetName, 0, function(json){
		if(json.length > 0)
		{
			...
			console.log('streamed', tapOutData.length)
		}
		else
		{
			console.log('done')
...
/*
function changeUserDataSet(userChosenDataSet)
{
	datasetName = userChosenDataSet;
	setup();
}
*/
